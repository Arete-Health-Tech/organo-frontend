    ...
    ***************************************************************************** */
    ...
    function Component(_a) {
        ...
        return (React.createElement("svg", __assign({ fill: "none", viewBox: "0 0 66 66" }, svgProps),
            coords.map(function (c, i) { return (React.createElement("circle", { key: "".concat(c.x, "-").concat(c.y), cx: "33", cy: "33", fill: "currentColor", r: 3 * (thickness / 100), style: __assign({ transform: "translate(".concat(c.x, "px, ").concat(c.y, "px)") }, generateCircleStyle(i)) })); }),
