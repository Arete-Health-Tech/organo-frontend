(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function Component$4(_a) {
        var _b = _a.speed, speed = _b === void 0 ? defaultProps$1.speed : _b, _c = _a.still, still = _c === void 0 ? defaultProps$1.still : _c, _d = _a.thickness, thickness = _d === void 0 ? defaultProps$1.thickness : _d, svgProps = __rest(_a, ["speed", "still", "thickness"]);
        var duration = 200 / speed;
        var generateCircleStyle = function (i) { return (!still
            ? { animation: "spinners-react-dotted-shrink ".concat(duration, "s cubic-bezier(0, 0.9, 0, 0.9) ").concat((duration / 20) * i, "s infinite") }
            : {}); };
        var centerStyle = !still
            ? {
                animation: "spinners-react-dotted-center ".concat(duration, "s ease-out infinite"),
                transformOrigin: 'center',
            }
            : { display: 'none' };
        return (React.createElement("svg", __assign({ fill: "none", viewBox: "0 0 66 66" }, svgProps),
            coords$1.map(function (c, i) { return (React.createElement("circle", { key: "".concat(c.x, "-").concat(c.y), cx: "33", cy: "33", fill: "currentColor", r: 3 * (thickness / 100), style: __assign({ transform: "translate(".concat(c.x, "px, ").concat(c.y, "px)") }, generateCircleStyle(i)) })); }),
